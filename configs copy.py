...
def ParseParams():
    ...
    parser.add_argument('--n_train', default=1000,type=int, help='Number of training steps')
    parser.add_argument('--test_size', default=500,type=int, help='Number of problems in test set')
